...
public:
    ...
    static size_t distance(size_t i1, size_t i2) { return i1 > i2 ? i1 - i2 : i2 - i1; }
...
struct fifteen_further {
    ...
    inline bool operator( )(const fifteen &f1, const fifteen &f2) const { return f1.distance() > f2.distance(); }
};

struct fifteen_equals {
    inline bool operator( )(const fifteen &f1, const fifteen &f2) const { return f1.equals(f2); }
};
